...
* [How Targeting Works in UIlicious](how-targeting-works-in-uilicious.md)

## Getting Started

* [Create your First Test](getting-started/create-your-first-test.md)
* [Share Test Reports](getting-started/share-test-reports.md)
* [Add Users to Workspace](getting-started/add-users-to-workspace.md)
* [Select Browsers & Resolutions](getting-started/select-browsers-and-resolutions.md)

## How to Guides

* [Reusing Tests](how-to-guides/reusing-tests.md)
* [Test File Uploads](how-to-guides/test-file-uploads.md)
* [Schedule an Automated Job](how-to-guides/schedule-an-automated-job.md)
* [How to Set Up Notifications](how-to-guides/how-to-set-up-notifications/README.md)
  * [Set up Email Notifications](how-to-guides/how-to-set-up-notifications/set-up-email-notifications.md)
  ...
  * [Set up Slack Notifications](how-to-guides/how-to-set-up-notifications/set-up-slack-notifications.md)
  * [Set up Teams Notifications](how-to-guides/how-to-set-up-notifications/set-up-teams-notifications.md)
* [Manage Test Data](how-to-guides/manage-test-data/README.md)
  ...
  * [Load Test Data from File](how-to-guides/manage-test-data/load-test-data-from-file/README.md)
    * [Read Data from CSV or JSON file](how-to-guides/manage-test-data/load-test-data-from-file/read-data-from-csv-or-json-file.md)
...
* [Use UIlicious with XYZ Framework](frameworks/use-uilicious-with-xyz-framework.md)
* [Salesforce](frameworks/salesforce.md)
* [SAP](frameworks/sap.md)
* [Sharepoint](frameworks/sharepoint.md)

## Command Line Interface

* [Install CLI Tool](command-line-interface/install-cli-tool.md)
* [Run and Reuse Tests with CLI](command-line-interface/run-and-reuse-tests-with-cli.md)
* [Data Objects](command-line-interface/data-objects.md)
* [Upload Files to Project](command-line-interface/upload-files-to-project.md)
* [Download Files From Project](command-line-interface/download-files-from-project.md)
* [CI/CD Integration](command-line-interface/ci-cd-integration.md)
